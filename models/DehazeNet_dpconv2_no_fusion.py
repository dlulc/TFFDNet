...
class DehazeNet(nn.Module):
    ...
    def forward(self, x):
        ...
        details_block2 = self.detail4(self.detail3(details_block1))
        # fusion2 = self.fusion2(block2_out, details_block2)

        details_block3 = self.detail6(self.detail5(details_block2))
        # fusion3 = self.fusion3(block3_out, details_block3)

        details_block4 = self.detail8(self.detail7(details_block3))
